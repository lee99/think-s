【缘起】
本程序是本人在想用THINKPHP3开发一小项目时，旧的环境不适合，也有一些新人还不懂怎样搭开发环境，所以有了做一个小小的环境的想法，无论老手新手都能用比较简单的方法快速搭起一个开发环境。
【感谢】
本程序借鉴了很多很优秀的集成开发环境：
...
当然，我要感谢THINKPHP!
【联系】
如果程序有问题请联系我：lee99.com[at]gmail.com
【注意】
本软件只适合于开发环境，不适合于生产环境！切记！

【软件特色】
1.100%适合THINKPHP的运行环境。
2.绿色，不写注册表，不写系统服务，不限制运行目录名。招之即来，挥之即去。
3.可升级，随时同步官方SVN库（核心程序，文档，示例，扩展库）。
4.组件配置可编辑，一步应用新配置，目录为[THINK-S]/SERVER/conf_template。
